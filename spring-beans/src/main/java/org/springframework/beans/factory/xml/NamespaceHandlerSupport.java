...
public abstract class NamespaceHandlerSupport implements NamespaceHandler {
	...
	/**
	 * BeanDefinitionParserDelegate 的 parseCustomElement 方法最后 NamespaceHandler 执行 parse
