...
public abstract class AbstractBeanDefinition extends BeanMetadataAttributeAccessor
	...
	/**
	 * autowire-candidate 属性设置为 false,这也容器在查找自动装配对象时，将不考虑该 bean ，
	 * 即它不会被考虑作为其他 bean 自动装配的候选人，但是该 bean 本身还是可以使用自动装配来注入其他 bean
